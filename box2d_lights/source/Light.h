...
protected:
    ...
    ComplexTriangulator _triangulator;
    
    clock_t _updateTimer;
    clock_t _updateRate = 0.01f * CLOCKS_PER_SEC;
...
#pragma mark Static Constructors
     ...
     */
    static std::shared_ptr<Light> alloc(const Vec2 pos) {
...
//    void calculateLightMesh();
    ...
    Mesh<SpriteVertex2> calculateLightMesh();
